...
namespace AsyncInMVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Designation,Salary")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Designation,Salary")] Employee employee)
        {
            if (ModelState.IsValid)
            {
